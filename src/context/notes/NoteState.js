    ...
    const getNotes = async () => {
        try {
            ...
            if (!response.ok) {
                ...
                props.showAlert && props.showAlert("Server error occurred while fetching notes", "danger");
                return;
            }
    ...
    const addNote = async (title, description, tag) => {
        try {
            ...
            if (!response.ok) {
                ...
                const errorText = await response.text();
                console.error("Server error:", errorText);
                props.showAlert && props.showAlert("Server error occurred while adding note", "danger");
                return;
            }
    ...
    const deleteNote = async (id) => {
        try {
            ...
            if (!response.ok) {
                ...
                const errorText = await response.text();
                console.error("Server error:", errorText);
                props.showAlert && props.showAlert("Server error occurred while deleting note", "danger");
                return;
            }
    ...
    const editNote = async (id, title, description, tag) => {
        try {
            ...
            if (!response.ok) {
                ...
                const errorText = await response.text();
                console.error("Server error:", errorText);
                props.showAlert && props.showAlert("Server error occurred while updating note", "danger");
                return;
            }
